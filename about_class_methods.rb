...
class AboutClassMethods < Neo::Koan
  ...
  # Often would prefer the first, as it's more succinct 
  # If you are planning on having lots of class methods though,
  # it could be helpful to have those structurally separated
