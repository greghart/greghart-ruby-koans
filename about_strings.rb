...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # More efficient if you don't need the original string
    # hi += there ~ "hi = hi + there". You are building a new string and 
    # assigning that, instead of inplace concatenation
  end
