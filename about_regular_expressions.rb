...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # They take first occurrence they can
  ...
  # Alternation can perform back tracking, having to check multiple scenarios
  # Character class just matches
  ...
  def test_sub_is_like_find_and_replace_2
